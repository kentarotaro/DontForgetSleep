...
class _SleepHistoryPageState extends State<SleepHistoryPage> {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        // final insightLoading = dailyInsightService.isLoading;
        // final insightError = dailyInsightService.errorCode;
              ...
              : Scaffold(
                  ...
                  body: RefreshIndicator(
                    ...
                    onRefresh: () async {
                      ...
                      await dailyInsightService.fetchTodayInsight();
                    },
  ...
  // }) {
  //   String message = 'No insight yet for today.';
  //   if (errorCode == 'INSUFFICIENT_SLEEP_DATA') {
  //     message = 'Need at least 5 sleep logs to generate today\'s insight.';
  //   } else if (errorCode != null && errorCode != 'EMPTY_DATA') {
  //     message = 'Insight is unavailable right now.';
  //   }
  // 
  //   return Container(
  ...
  //       border: Border.all(color: const Color(0xFF26344D), width: 1),
  //     ),
  //     child: Column(
  //       crossAxisAlignment: CrossAxisAlignment.start,
  //       children: [
